...
<form action="<c:url value='/crm/update'/>" method="post">
<table border="0" align="center" width="40%" style="margin-left: 100px;">
	<tr>
		<td width="100px">客户名称</td>
		<td width="40%">
			<input type="text" name="cname" value="${cus.cname}"/>
	...
	<tr>
		<td>客户性别</td>
		<td>
			<input type="radio" name="gender" value="男" id="male"  <c:if test="${cus.gender eq '男'}">checked</c:if>/>
			<label for="male">男</label>
			<input type="radio" name="gender" value="女" id="female" <c:if test="${cus.gender eq '女'}">checked</c:if>/>
	...
	<tr>
		<td>客户生日</td>
		<td>
			<input type="text" name="birthday" id="birthday" readonly="readonly" value="${cus.birthday}"/>
		</td>
		<td>
	...
	<tr>
		<td>描述</td>
		<td>
			<textarea rows="5" cols="30" name="description"  >${cus.description}</textarea>
		</td>
		<td>
